...
if(empty($gmeet_setting) || !$gmeet_setting->use_api){
    ?>
<div class="form-group col-sm-12 col-md-12 col-lg-12">
                            <label for="url"> <?php echo $this->lang->line('gmeet')." ".$this->lang->line('url'); ?> (<?php echo $this->lang->line('how_to_get');  ?> <a class="labelurl" href="https://www.youtube.com/watch?v=7xwLGWh503Q" target="_blank"> <?php echo $this->lang->line('gmeet')." ".$this->lang->line('url'); ?></a>? )<small class="req"> *</small> </label>
