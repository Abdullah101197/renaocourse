...
<body>
    ...
    <a href="<?php echo site_url('group/create'); ?>">Create New Group</a>
    <table border="1">
        <tr>
            <th>ID</th>
            <th>Name</th>
        ...
        <tr>
            ...
            <td><?php echo $group->method; ?></td>
            <td><?php echo $group->type; ?></td>
            <td><?php echo $group->teacher_id; ?></td>
            <td><?php echo $group->level; ?></td>
            <td>
                <a href="<?php echo site_url('group/edit/'.$group->id); ?>">Edit</a>
                <a href="<?php echo site_url('group/delete/'.$group->id); ?>">Delete</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
