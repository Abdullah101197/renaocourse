                                        ...
                                        foreach ($side_list_value->submenus as $submenu_key => $submenu_value) {
                                            ...
                                            if (!empty($sidebar_permission)) {
                                                foreach ($sidebar_permission as $sidebar_permission_key => $sidebar_permission_value) {
                                                    ...
                                                    // Debug: Log addon permission for each submenu
                                                    log_message('debug', 'Checking addon permission for: ' . $submenu_value->addon_permission);

                                                    if ($submenu_value->addon_permission != "") {
                                                        // Check addon permission and activation
                                            ...
                                            // Check if the sidebar access is allowed and if the module is active
                                            if ($sidebar_access) {
