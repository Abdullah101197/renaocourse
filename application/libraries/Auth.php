...
{
    // Disable the validation and allow access for all products
    return true; // Always return true to bypass the validation

    // If you want to disallow all addons, you can return false instead:
    // return false;

    // If you still want to handle the return_url, uncomment the code below
    if ($return_url) {
        redirect($return_url);
        exit;
    }
